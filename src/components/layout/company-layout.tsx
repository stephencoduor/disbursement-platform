...
const pageTitles: Record<string, string> = {
  ...
  "/disburse": "Single Disbursement",
  "/disburse/bulk": "Bulk Disbursement",
  "/approvals": "Approvals",
  ...
  "/deposits": "Self-service Deposits",
  "/mobile-app": "Employee App",
...
export default function CompanyLayout() {
  ...
  const pageTitle =
    ...
    (location.pathname.startsWith("/employees/")
      ? "Employee Detail"
      : location.pathname.startsWith("/disburse/review/")
        ? "Review Disbursement"
